...
#define S_FE                        1.504746866         /// <summary>Feのスピン角運動量                                        </summary>
...
#define BULK_D_FE_FE                2.238102360e-16     /// <summary>薄膜整形前の異方性定数                                    </summary>
#define THERMAL_GRADIENT            15.0649             /// <summary>温度勾配(T/nm)                                            </summary>
#define TEMP_AMBIENT                330.0               /// <summary>動作温度(K)                                               </summary>
#define BIT_AREA                    140.0               /// <summary>ビット面積(nm^2)                                          </summary>
