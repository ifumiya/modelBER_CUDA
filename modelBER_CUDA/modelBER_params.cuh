...
#define HW_MAX                      20.0e+3F             /// <summary>KuKbulk-Hwグラフ作成時に計算を途中で放棄するHw            </summary>
...
#define TEMP_CURIE_SD               0.05F                /// <summary>Tc分散                                                    </summary>
...
#define CBER_HW                     10e+3F               /// <summary>試行周期ごとのbERを算出する際の書込磁界(Oe)               </summary>
